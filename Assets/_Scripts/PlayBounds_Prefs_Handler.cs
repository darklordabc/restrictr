...
public class PlayBounds_Prefs_Handler : MonoBehaviour 
{
    ...
    public bool StartWithSteamVR {
        get {
            return prefs.global.StartWithSteamVR;
        }
        set {
    ...
    public bool globalIsEnabled {
        get {
            return prefs.global.settings.enabled;
        }
        set {
    ...
    public bool globalEnabledInDashboard {
        get {
            return prefs.global.settings.enabledInDashboard;
        }
        set {
    ...
    public bool globalPlayAlertSound {
        get {
            return prefs.global.settings.playAlertSound;
        }
        set {
    ...
    public bool globalDoNotActivateIfFacingDown {
        get {
            return prefs.global.settings.doNotActivateIfFacingDown;
        }
        set {
    ...
    public PlayBoundsPrefs.PlayBoundPrefsSettings.BoundsBoxVisibility globalBoundsBoxVisibility {
        get {
            return prefs.global.settings.boundsBoxVisibility;
        }
        set {
    ...
    public float globalColorRed {
        get {
            return prefs.global.settings.colorRed;
        }
        set {
    ...
    public float globalColorGreen {
        get {
            return prefs.global.settings.colorGreen;
        }
        set {
    ...
    public float globalColorBlue {
        get {
            return prefs.global.settings.colorBlue;
        }
        set {
    ...
    public float globalBoundsSize {
        get {
            return prefs.global.settings.boundsSize;
        }
        set {
    ...
    public float globalTimeFadeIn {
        get {
            return prefs.global.settings.timeFadeIn;
        }
        set {
    ...
    public float globalTimeFadeOut {
        get {
            return prefs.global.settings.timeFadeOut;
        }
        set {
    ...
    public float globalTimeTextFlash {
        get {
            return prefs.global.settings.timeTextFlash;
        }
        set {
    ...
    public string globalTextReturn {
        get {
            return prefs.global.settings.textReturn;
        }
        set {
    ...
    public string globalTextStepLeft {
        get {
            return prefs.global.settings.textStepLeft;
        }
        set {
    ...
    public string globalTextStepRight {
        get {
            return prefs.global.settings.textStepRight;
        }
        set {
    ...
    public string globalTextStepBack {
        get {
            return prefs.global.settings.textStepBack;
        }
        set {
    ...
    public string globalTextStepForward {
        get {
            return prefs.global.settings.textStepForward;
        }
        set {
...
[System.Serializable] public class PlayBoundsPrefs 
{
    ...
    public class PlayBoundPrefsSettings {
        ...
        public enum BoundsBoxVisibility { WhenVisionIsBlocked, WhenVisionIsBlocked5Seconds, AlwaysVisible};
