...
public partial class PlayBounds_Director : MonoBehaviour 
{
	...
	public PlayBounds_Menu_Redux menuRig;
	...
	{
        /*floorOverlay.transform.position = new Vector3(
                hmdO.transform.position.x,
                hmdO.transform.position.y,
                hmdO.transform.position.z + 0.1f
                );*/
		...
		else if(prefs.FollowPlayerHeadset)
		{
            ...
            //floorOverlay.transform.position = newPos;
		}
    }*/
