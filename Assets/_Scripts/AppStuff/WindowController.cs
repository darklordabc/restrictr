...
public class WindowController : MonoBehaviour
{
    ...
    private PlayBounds_Director director;
    ...
    private PlayBoundsTrayForm trayForm;
    ...
    void Start()
    {
        director = GetComponent<PlayBounds_Director>();
...
public class PlayBoundsTrayForm : System.Windows.Forms.Form 
{
    ...
    public PlayBoundsTrayForm(Texture2D tex = null)
    {
        trayMenu = new System.Windows.Forms.ContextMenuStrip();
        
        if(tex)
            trayMenu.Items.Add("Show Restrictr", CreateBitmap(tex), OnShowWindow);
        else
            trayMenu.Items.Add("Show Restrictr", CreateBitmap(Texture2D.whiteTexture), OnShowWindow);

        trayMenu.Items.Add("Exit", CreateBitmap(Texture2D.whiteTexture), OnExit);

        trayIcon = new NotifyIcon();
        trayIcon.Text = "Restrictr";
